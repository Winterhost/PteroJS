...
export class EggsManager extends BaseManager {
    ...
    adminURLFor(id: number): string {
        return `${this.client.domain}/admin/eggs/${id}`;
    }
     ...
     * @example
     * ```
     * app.eggs.fetch(1, 16).then(console.log).catch(console.error);
     * ```
     */
    async fetch(
        id: number,
